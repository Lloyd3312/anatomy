pipeline {
    ...
    environment {
        IMAGE_NAME = "nwachukwuchukwuka123/anatomy"
    ...
    stages {
        ...
        stage('Run in Docker') {
            ...
            steps {
                ...
                docker stop anatomy-container || true

                # Remove the old container if it exists
                docker rm anatomy-container || true
            ...
            steps {
                script {
                    withCredentials([usernamePassword(
                        ...
                        git push \
                        https://\$GIT_USERNAME:\$GIT_TOKEN@github.com/santos-alaska/anatomy.git \
                        main
                        """
                    }
                }
